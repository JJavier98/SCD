...
{
  	cout << "El cliente " << clienteActual << " ha sido pelado" << endl;
  	silla.signal();
}


void CortarPeloACliente(MRef<MbarberiaSU> Barberia){

	cout << "El barbero empieza a cortar el pelo al cliente: " << Barberia->getCliente() << endl;
