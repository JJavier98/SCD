...
int ProducirIngrediente( )
{
   ...
   chrono::milliseconds duracion_producir( aleatorio<200,250>() );
...
private:
	CondVar cola_fumador[FUMADORES]; 	// condición: almacen[i]<2
	CondVar cola_estanqueros;				// condición: mostrador != -1
	int mostrador;
	int almacen[FUMADORES];
public:
	Estanco ();
